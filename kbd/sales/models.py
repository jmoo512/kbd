...
class Sales(db.Model):
    ...
    def __init__(self, week_ending, fiscal_month, fiscal_year, week_of_month, week_of_year, concept, location, sales, bbq_sales, taco_sales, group_meal_sales, mavn_sales, doordash_sales, total_guest_count, bbq_guest_count, taco_guest_count):
